...
function scanDashas(dashas: DashaPeriod[], k: KundliResult, area: "marriage" | "career", minScore: number): TimingWindow[] {
  ...
  for (const md of dashas) {
    ...
    for (const ad of md.antardashas) {
      ...
      let reasonHi = "";
      if (area === "marriage") {
        reasonMr = `${mdMr} महादशा + ${adMr} अंतर्दशा — वैवाहिक योग अनुकूल. ग्रह शक्ती: ${combinedScore}/१०.`;
        reasonEn = `${md.lord} Mahadasha + ${ad.lord} Antardasha — favourable for marriage. Combined strength: ${combinedScore}/10.`;
        reasonHi = `${mdMr} महादशा + ${adMr} अंतर्दशा — विवाह हेतु अनुकूल. शक्ति: ${combinedScore}/10.`;
      } else {
        reasonMr = `${mdMr} महादशा + ${adMr} अंतर्दशा — करिअरमध्ये उन्नती संभव. ग्रह शक्ती: ${combinedScore}/१०.`;
        reasonEn = `${md.lord} Mahadasha + ${ad.lord} Antardasha — career advancement likely. Combined strength: ${combinedScore}/10.`;
        reasonHi = `${mdMr} महादशा + ${adMr} अंतर्दशा — करियर में उन्नति संभव. शक्ति: ${combinedScore}/10.`;
      }
