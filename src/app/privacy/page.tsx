      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#5c1a1a]/70 mt-2 text-sm">
            {t(
              "वेंकटेश ज्योतिष — तुमच्या माहितीची काळजी आम्हाला आहे",
              "Venkatesh Astrology — We care about your data privacy"
            )}
          </p>
        ...
        <div className="bg-white rounded-xl border border-[#d4a843]/20 p-6 shadow-sm mb-6">
          <p className="text-sm text-[#5c1a1a]/80 leading-relaxed">
            {t(
              "वेंकटेश ज्योतिष (\"आम्ही\") तुमच्या गोपनीयतेचा आदर करतो. हे गोपनीयता धोरण आमच्या वेबसाइट आणि सेवा वापरताना तुमची माहिती कशी संकलित, वापरली आणि संरक्षित केली जाते हे स्पष्ट करते.",
              "Venkatesh Astrology (\"we\") respects your privacy. This privacy policy explains how your information is collected, used, and protected when you use our website and services."
            )}
          </p>
        </div>
