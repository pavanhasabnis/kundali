...
export default function MatchingPageClient() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8]">
      <JsonLd data={serviceSchema({ name: "Gun Milaan — गुण मिलान", description: "Free Ashtakoot gun milaan for marriage compatibility. 36-point matching with Varna, Vashya, Tara, Yoni, Maitri, Gana, Bhakoot & Nadi analysis.", url: "https://bhaagyavedh.com/matching" })} />
      <JsonLd data={breadcrumbSchema([{ name: "Home", url: "https://bhaagyavedh.com" }, { name: "Gun Milaan", url: "https://bhaagyavedh.com/matching" }])} />
