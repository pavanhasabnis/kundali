...
function SectionHead({ pageMr, pageEn, titleMr, titleEn, t }: { pageMr: string; pageEn: string; titleMr: string; titleEn: string; t: (mr: string, en: string) => string }) {
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
      <p className="text-xs tracking-[0.2em] uppercase mb-2" style={{ color: "rgba(212,168,67,0.4)" }}>{t(pageMr, pageEn)}</p>
      <h2 className="text-2xl sm:text-3xl font-bold text-white">{t(titleMr, titleEn)}</h2>
  ...
  return (
    <>
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}>
            ...
            <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full mb-8"
              ...
              <span className="text-sm font-medium" style={{ color: "#d4a843" }}>
                {t("श्री गणेशाय नमः | संपूर्ण धार्मिक सेवा", "Shri Ganeshay Namah | Complete Spiritual Services")}
              </span>
            </div>
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-4 leading-tight">
              <span style={{ background: "linear-gradient(135deg, #f0c040, #d4a843, #c49535)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                {t("भाग्यवेध", "Bhaagyavedh")}
              </span>
              <br />
              <span className="text-white/90 text-4xl sm:text-5xl md:text-6xl">
                {t("ज्योतिष व धार्मिक सेवा", "Astrology & Spiritual Services")}
              </span>
            </h1>
            ...
            <p className="text-sm mb-6" style={{ color: "rgba(212,168,67,0.4)" }}>
              {t("मराठी व इंग्रजी | वैदिक ज्ञान + आधुनिक सेवा", "Marathi & English | Vedic Wisdom + Modern Services")}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
              ...
              <Link href="/yatra"
                ...
                {t("यात्रा पॅकेजेस", "Travel Packages")}
              </Link>
              <Link href="/rashifal"
                className="px-8 py-4 rounded-full font-semibold text-base transition-all hover:-translate-y-0.5 hover:bg-white/5"
                style={{ border: "1px solid rgba(212,168,67,0.3)", color: "#d4a843" }}>
            ...
            <div className="grid grid-cols-5 gap-4 max-w-2xl mx-auto">
              {[
                ...
                { v: 12, l: t("राशी", "Rashis") },
                { v: 14, l: t("यात्रा", "Yatras") },
                { v: 170, l: t("ठिकाणे", "Places") },
                { v: 50, l: t("मंदिरे", "Temples") },
              ].map((s, i) => (
      ...
      <section className="py-16" style={{ background: "linear-gradient(180deg, #1a0505, #2a0808)" }}>
        <SectionHead pageMr="पृष्ठ १" pageEn="Page 1" titleMr="ज्योतिष सेवा" titleEn="Astrology Services" t={t} />
        <OpenBook pageNum="१"
          leftContent={
            <div>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#3d0c0c" }}>{t("कुंडली व भविष्य", "Kundli & Predictions")}</h3>
              <div className="space-y-3">
                {[
                  ...
                  { sym: "✦", title: t("दैनिक राशीफल", "Daily Horoscope"), desc: t("वास्तविक गोचरावर आधारित भविष्य", "Predictions based on real transits"), href: "/rashifal" },
                  { sym: "⌂", title: t("मुहूर्त शोधक", "Muhurat Finder"), desc: t("वास्तुशांती, गृहप्रवेश, विवाह मुहूर्त", "Vastushanti, Gruhapravesh, Vivah muhurat"), href: "/muhurat" },
                ].map((s, i) => (
          ...
          rightContent={
            <div>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#3d0c0c" }}>{t("पंचांग व ग्रह", "Panchang & Planets")}</h3>
              <div className="space-y-3">
                {[
                  ...
                  { sym: "₹", title: t("ज्योतिष सल्ला", "Consultation"), desc: t("अनुभवी ज्योतिषांकडून वैयक्तिक सल्ला", "Personal consultation by experienced astrologers"), href: "/consultation" },
                ].map((s, i) => (
                  <Link key={i} href={s.href} className="group flex gap-3 items-start p-3 rounded-xl hover:bg-white/50 transition-all" style={{ border: "1px solid rgba(212,168,67,0.1)" }}>
                    <div className="w-9 h-9 rounded-lg flex items-center justify-center text-base shrink-0" style={{ background: "linear-gradient(135deg, #3d0c0c, #5c1a1a)", color: "#d4a843" }}>{s.sym}</div>
                    <div>
      ...
      <section className="py-16" style={{ background: "#1a0505" }}>
        <SectionHead pageMr="पृष्ठ २" pageEn="Page 2" titleMr="धार्मिक यात्रा सेवा" titleEn="Pilgrimage Travel Services" t={t} />
        <OpenBook dark pageNum="२"
          leftContent={
            <div>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#d4a843" }}>{t("लोकप्रिय यात्रा", "Popular Pilgrimages")}</h3>
              <div className="space-y-3">
                {[
                  { icon: "🔱", title: t("ज्योतिर्लिंग यात्रा", "Jyotirlinga Yatra"), desc: t("१२ ज्योतिर्लिंग — संपूर्ण भारत दर्शन", "12 Jyotirlingas — Pan India darshan"), href: "/yatra/jyotirlinga" },
                  { icon: "🏔️", title: t("चार धाम यात्रा", "Char Dham Yatra"), desc: t("बद्रीनाथ, केदारनाथ, गंगोत्री, यमुनोत्री", "Badrinath, Kedarnath, Gangotri, Yamunotri"), href: "/yatra/char-dham" },
                  { icon: "🙏", title: t("अष्टविनायक दर्शन", "Ashtavinayak Tour"), desc: t("महाराष्ट्रातील ८ पवित्र गणपती मंदिरे", "8 sacred Ganapati temples in Maharashtra"), href: "/yatra/ashtavinayak" },
                  { icon: "🪷", title: t("शक्तिपीठ दर्शन", "Shakti Peeth Tour"), desc: t("साडेतीन शक्तिपीठे — कोल्हापूर, तुळजापूर, माहूर", "3.5 Shakti Peethas — Kolhapur, Tuljapur, Mahur"), href: "/yatra/shakti-peeth" },
                ].map((s, i) => (
          ...
          rightContent={
            <div>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#d4a843" }}>{t("अधिक यात्रा", "More Pilgrimages")}</h3>
              <div className="space-y-3">
                {[
                  { icon: "🪔", title: t("काशी-प्रयागराज-अयोध्या", "Kashi-Prayagraj-Ayodhya"), desc: t("गंगा आरती, संगम स्नान, राम मंदिर दर्शन", "Ganga Aarti, Sangam, Ram Mandir darshan"), href: "/yatra/varanasi" },
                  { icon: "🙏", title: t("शिर्डी-शनि शिंगणापूर", "Shirdi-Shani Shingnapur"), desc: t("साईबाबा दर्शन, त्र्यंबकेश्वर, पंचवटी", "Sai Baba darshan, Trimbakeshwar, Panchavati"), href: "/yatra/shirdi" },
                  { icon: "🏛️", title: t("द्वारका-सोमनाथ", "Dwarka-Somnath"), desc: t("श्रीकृष्ण नगरी, सोमनाथ ज्योतिर्लिंग, गिरनार", "Krishna's city, Somnath Jyotirlinga, Girnar"), href: "/yatra/dwarka" },
                  { icon: "⛩️", title: t("तिरुपती दर्शन", "Tirupati Darshan"), desc: t("बालाजी VIP दर्शन — कल्याणम, लड्डू प्रसादम", "Balaji VIP darshan — Kalyanam, Laddu Prasadam"), href: "/yatra/tirupati" },
                ].map((s, i) => (
                  <Link key={i} href={s.href} className="group flex gap-3 items-start p-3 rounded-xl hover:bg-white/10 transition-all" style={{ border: "1px solid rgba(212,168,67,0.15)" }}>
                    <div className="w-9 h-9 rounded-lg flex items-center justify-center text-lg shrink-0">{s.icon}</div>
                    <div>
              ...
              <div className="mt-4 pt-3 text-center" style={{ borderTop: "1px dashed rgba(212,168,67,0.15)" }}>
                <Link href="/yatra" className="text-sm font-semibold px-8 py-2.5 rounded-full inline-block"
                  style={{ border: "1px solid rgba(212,168,67,0.3)", color: "#d4a843" }}>
                  {t("सर्व यात्रा पहा →", "View All Pilgrimages →")}
                </Link>
              </div>
            </div>
          }
      ...
      {featuredPkgs.length > 0 && (
        <section className="py-16" style={{ background: "linear-gradient(180deg, #1a0505, #2a0808)" }}>
          <SectionHead pageMr="पृष्ठ ३" pageEn="Page 3" titleMr="विशेष यात्रा पॅकेजेस" titleEn="Featured Travel Packages" t={t} />
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {featuredPkgs.map((pkg, i) => (
                <motion.div key={pkg.id}
                  ...
                  <Link href={`/yatra/${pkg.category.replace(/_/g, "-")}`}
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-medium" style={{ color: "#d4a843" }}>{t("पहा", "View")} &rarr;</span>
                      </div>
                    </div>
                  </Link>
                </motion.div>
      ...
      <section className="py-16" style={{ background: "#1a0505" }}>
        <SectionHead pageMr="पृष्ठ ४" pageEn="Page 4" titleMr="पूजा सेवा व मंदिरे" titleEn="Pooja Services & Temples" t={t} />
        <OpenBook pageNum="४"
          leftContent={
            <div>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#3d0c0c" }}>{t("पूजा व कर्मकांड", "Pooja & Rituals")}</h3>
              <div className="space-y-3">
                {[
                  { sym: "🔥", title: t("हवन / होम", "Havan / Hom"), desc: t("गणेश हवन, नवग्रह हवन, शांती हवन", "Ganesh Havan, Navagraha Havan, Shanti Havan") },
                  { sym: "🙏", title: t("सत्यनारायण पूजा", "Satyanarayan Pooja"), desc: t("घरी किंवा मंदिरात — अनुभवी गुरुजींसह", "At home or temple — with experienced Guruji") },
                  { sym: "🏠", title: t("वास्तुशांती / गृहप्रवेश", "Vastushanti / Gruhapravesh"), desc: t("नवीन घर किंवा कार्यालय — शास्त्रोक्त विधी", "New home or office — traditional rituals") },
                  { sym: "💍", title: t("लग्नविधी", "Wedding Rituals"), desc: t("संपूर्ण लग्न विधी — मंगलाष्टक, सप्तपदी", "Complete wedding rituals — Mangalashtak, Saptapadi") },
                ].map((s, i) => (
              ...
              <div className="mt-4 pt-3 text-center" style={{ borderTop: "1px dashed rgba(212,168,67,0.15)" }}>
                <Link href="/pooja-services" className="text-sm font-semibold px-6 py-2 rounded-full inline-block"
                  style={{ background: "linear-gradient(135deg, #d4a843, #c49535)", color: "#1a0505" }}>
                  {t("सर्व पूजा सेवा →", "All Pooja Services →")}
                </Link>
              </div>
            </div>
          }
          rightContent={
            <div>
              <h3 className="text-lg font-bold mb-4" style={{ color: "#3d0c0c" }}>{t("प्रसिद्ध मंदिरे", "Famous Temples")}</h3>
              <div className="space-y-3">
                {[
                  { sym: "🛕", title: t("ज्योतिर्लिंग मंदिरे", "Jyotirlinga Temples"), desc: t("१२ ज्योतिर्लिंगांची संपूर्ण माहिती", "Complete info on 12 Jyotirlingas") },
                  { sym: "🙏", title: t("अष्टविनायक मंदिरे", "Ashtavinayak Temples"), desc: t("महाराष्ट्रातील ८ गणपती मंदिरे", "8 Ganapati temples in Maharashtra") },
                  { sym: "🪷", title: t("शक्तिपीठ मंदिरे", "Shakti Peeth Temples"), desc: t("देवी शक्तीची पवित्र स्थाने", "Sacred sites of Goddess Shakti") },
                  { sym: "📿", title: t("दत्तक्षेत्र मंदिरे", "Datta Kshetra Temples"), desc: t("दत्तात्रेयांची प्रमुख स्थाने", "Major Dattatreya shrines") },
                ].map((s, i) => (
                  <div key={i} className="flex gap-3 items-start p-3 rounded-xl" style={{ border: "1px solid rgba(212,168,67,0.1)" }}>
                    <div className="w-9 h-9 rounded-lg flex items-center justify-center text-lg shrink-0">{s.sym}</div>
                    <div>
              ...
              <div className="mt-4 pt-3 text-center" style={{ borderTop: "1px dashed rgba(212,168,67,0.15)" }}>
                <Link href="/temples" className="text-sm font-semibold px-6 py-2 rounded-full inline-block"
                  style={{ border: "1px solid rgba(212,168,67,0.2)", color: "#3d0c0c" }}>
                  {t("सर्व मंदिरे पहा →", "Explore All Temples →")}
                </Link>
              </div>
            </div>
          }
      ...
      <section className="py-16" style={{ background: "linear-gradient(180deg, #2a0808, #1a0505)" }}>
        <SectionHead pageMr="पृष्ठ ५" pageEn="Page 5" titleMr="१२ राशी — राशीचक्र" titleEn="12 Zodiac Signs" t={t} />
      ...
      {/* ══════ BOOK 5: WHY US + BLOG ══════ */}
      <section className="py-16" style={{ background: "#1a0505" }}>
        <SectionHead pageMr="पृष्ठ ६" pageEn="Page 6" titleMr="आम्ही वेगळे का?" titleEn="Why Choose Us?" t={t} />
        <OpenBook pageNum="६"
          leftContent={
            <div>
              <h3 className="text-base font-bold mb-5" style={{ color: "#8b2c2c" }}>{t("अचूक गणना", "Accurate Calculations")}</h3>
              <div className="space-y-4">
                {[
                  { t: t("वास्तविक ग्रह गणना", "Real Planetary Calculations"), d: t("९ ग्रहांची अचूक स्थिती — लाहिरी अयनांश", "Accurate positions of 9 planets — Lahiri Ayanamsa") },
                  { t: t("९ कुंडली चार्ट", "9 Kundli Charts"), d: t("लग्न, चंद्र, नवमांश, भाव चलित, दशमांश आणि अधिक", "Lagna, Chandra, Navamsha, Bhav Chalit, D10 and more") },
          ...
          rightContent={
            <div>
              <h3 className="text-base font-bold mb-5" style={{ color: "#8b2c2c" }}>{t("संपूर्ण धार्मिक सेवा", "Complete Spiritual Services")}</h3>
              <div className="space-y-4">
                {[
                  { t: t("१४+ यात्रा श्रेणी", "14+ Travel Categories"), d: t("ज्योतिर्लिंग, चार धाम, अष्टविनायक ते सानुकूल यात्रा", "Jyotirlinga, Char Dham, Ashtavinayak to custom pilgrimages") },
                  { t: t("५०+ मंदिर माहिती", "50+ Temple Info"), d: t("इतिहास, स्थान, वेळा, दर्शन माहिती — सर्व एकत्र", "History, location, timings, darshan info — all in one place") },
                  { t: t("पूजा व कर्मकांड", "Pooja & Rituals"), d: t("अनुभवी गुरुजींसह सर्व विधी — हवन, पूजा, लग्नविधी", "All rituals with experienced priests — Havan, Pooja, Wedding") },
                ].map((f, i) => (
                  <div key={i} className="flex gap-3 items-start">
                    <div className="w-1.5 h-1.5 rounded-full mt-2 shrink-0" style={{ background: "#d4a843" }} />
                    <div>
              ...
              <div className="mt-4 pt-3 text-center" style={{ borderTop: "1px dashed rgba(212,168,67,0.15)" }}>
                <Link href="/blog" className="text-sm font-semibold px-6 py-2 rounded-full inline-block"
                  style={{ border: "1px solid rgba(212,168,67,0.2)", color: "#3d0c0c" }}>
                  {t("दैनिक लेख वाचा →", "Read Daily Blog →")}
                </Link>
              </div>
            </div>
          }
      ...
      <section className="py-20 relative overflow-hidden"
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
            {t("तुमचा आध्यात्मिक प्रवास सुरू करा", "Begin Your Spiritual Journey")}
          </h2>
