    ...
    <div className="min-h-screen bg-[#FAFAF8]">
      <section className="relative py-16 sm:py-24 overflow-hidden" style={{ background: "linear-gradient(135deg, #3d0c0c 0%, #5c1a1a 50%, #3d0c0c 100%)" }}>
        ...
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-[#d4a843] mb-3">{t("मुहूर्त शोधक", "Muhurat Finder")}</h1>
          <p className="text-white/60 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">{t("शुभ मुहूर्त शोधा — वास्तुशांती, गृहप्रवेश, विवाह, व्यापार", "Find auspicious dates — Vastushanti, Gruhapravesh, Marriage, Business")}</p>
        </div>
      </section>
