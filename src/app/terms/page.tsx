  ...
  const sections = [
    {
      ...
      contentMr:
        "वेंकटेश ज्योतिष वेबसाइट आणि सेवा वापरून तुम्ही या अटी व शर्ती स्वीकारता. या अटी स्वीकार नसल्यास कृपया आमच्या सेवा वापरू नका. आम्ही वेळोवेळी या अटींमध्ये बदल करू शकतो, आणि अद्ययावत अटी वेबसाइटवर प्रकाशित केल्या जातील.",
      contentEn:
        "By using the Venkatesh Astrology website and services, you accept these terms and conditions. If you do not accept these terms, please do not use our services. We may modify these terms from time to time, and updated terms will be published on the website.",
    },
    {
      titleMr: "मोफत सेवा",
    ...
    },
    {
      ...
      contentMr:
        "या वेबसाइटवरील सर्व सामग्री — मजकूर, डिझाइन, कोड, लोगो — वेंकटेश ज्योतिषची मालमत्ता आहे. लेखी परवानगीशिवाय कोणत्याही सामग्रीची कॉपी, पुनर्मुद्रण किंवा व्यावसायिक वापर करण्यास मनाई आहे.",
      contentEn:
        "All content on this website — text, design, code, logo — is the property of Venkatesh Astrology. Copying, reprinting, or commercial use of any content without written permission is prohibited.",
    },
    {
      titleMr: "मर्यादित दायित्व",
      titleEn: "Limitation of Liability",
      contentMr:
        "वेंकटेश ज्योतिष ज्योतिष अंदाज किंवा सल्ल्याच्या आधारे घेतलेल्या कोणत्याही निर्णयाच्या परिणामांसाठी जबाबदार नाही. आमच्या सेवा मार्गदर्शनासाठी आहेत आणि कोणत्याही विशिष्ट परिणामाची हमी दिली जात नाही.",
      contentEn:
        "Venkatesh Astrology is not responsible for the consequences of any decisions made based on astrological predictions or advice. Our services are for guidance only, and no specific outcomes are guaranteed.",
    },
    {
      titleMr: "लागू कायदा",
      titleEn: "Governing Law",
      contentMr:
        "या अटी व शर्ती भारतीय कायद्यांनुसार नियंत्रित केल्या जातात. कोणताही विवाद कोल्हापूर, महाराष्ट्र येथील न्यायालयांच्या अधिकार क्षेत्रात सोडवला जाईल.",
      contentEn:
        "These terms and conditions are governed by the laws of India. Any disputes shall be resolved under the jurisdiction of the courts in Kolhapur, Maharashtra.",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#5c1a1a]/70 mt-2 text-sm">
            {t(
              "वेंकटेश ज्योतिष — सेवा वापराच्या अटी",
              "Venkatesh Astrology — Terms of Service"
            )}
          </p>
        ...
        <div className="mt-8 bg-[#FFF8E7] rounded-xl border border-[#d4a843]/30 p-6 text-center">
          ...
          <p className="text-sm text-[#5c1a1a]/70 mt-1">info@venkateshastrology.com</p>
        </div>
